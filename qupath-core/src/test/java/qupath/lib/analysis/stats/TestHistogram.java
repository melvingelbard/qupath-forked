...
public class TestHistogram {
	...
	/**
	 * Test all types of histograms. Even though in this test all the backing array 
	 * (and list) are always a double array, to avoid repetition 3 times. Anyway, all the 
	 * {@code Histogram} constructors call the <b>private</b> {@code Histogram(ArrayWrapper)} method, 
	 * which was not visible from this test file.
	 */
	@Test
